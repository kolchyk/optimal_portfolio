...
| Step | Timing | Action |
|------|--------|--------|
| 1 | Monthly (~{_DEFAULTS.rebal_days} trading days), close of day T | Analyze signals: asset KAMA, gap filter, R\u00b2 scoring |
...
| Крок | Час | Дія |
|------|-----|-----|
| 1 | Щомісячно (~{_DEFAULTS.rebal_days} торг. днів), закриття дня T | Аналіз сигналів: KAMA активу, фільтр гепів, R² scoring |
